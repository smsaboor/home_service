class CreatePostBody {
  ...
  CreatePostBody({this.serviceId, this.categoryId,this.subCategoryId, this.addressId, this.serviceDescription, this.serviceSchedule,this.additionDescriptions});
